defmodule WhiteBreadContext do
  ...
  alias Takso.{Repo, Sales.Taxi}  # Add this line
  ...
  scenario_starting_state fn state ->
    ...
    Ecto.Adapters.SQL.Sandbox.mode(Takso.Repo, {:shared, self()})  # Update this line
    %{}
  end
  ...
  then_ ~r/^I should receive a rejection message$/, fn state ->
    assert visible_in_page? ~r/Booking request rejected/
    {:ok, state}
  end
