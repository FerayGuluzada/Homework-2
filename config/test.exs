...
config :takso, TaksoWeb.Endpoint,
  ...
  secret_key_base: "Enj/3ESPkM16b3RZhxVis3PpQp19mwAxzE+twIyvPf5XuyFAfkIr+sHLbcRA+7Ly",
...
config :hound, driver: "chrome_driver", port: 51871  # If needed, update the port according to the chrome_drive message
